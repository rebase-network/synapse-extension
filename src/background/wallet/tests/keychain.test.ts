...
describe('BIP32 Keychain tests', () => {
  ...
  it('derive children hardened', () => {
    ...
    expect(child.chainCode.toString('hex')).toEqual(
  ...
  it.skip('create child keychain from public key', () => {
    ...
    expect(grandchild.identifier.toString('hex')).toEqual(
  ...
  it('private key add', () => {
    ...
    expect(sum.toString('hex')).toEqual(
...
describe('private to public', () => {
  ...
  it('derive public key from private key wrong length', () => {
    ...
    expect(() =>
      privateToPublic(
        Buffer.from('39d218506b30ca69b0f3112427877d983dd3cd2cabc742ab723e2964d98016', 'hex'),
      ),
    ).toThrowError();
    expect(() =>
      privateToPublic(
        Buffer.from('0xbb39d218506b30ca69b0f3112427877d983dd3cd2cabc742ab723e2964d98016', 'hex'),
      ),
    ).toThrowError();
  });
});
