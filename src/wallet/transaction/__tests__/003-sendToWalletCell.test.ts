...
describe('Anypay Wallet', () => {
  ...
  it('create anypay wallet', async () => {
    ...
    const dataArgs = `0x${ckb.utils.blake160(
      '0x0335dc5d273ee1575d4a89a24859d92d25053c493b125a38d747d46635306d8a89',
      'hex',
    )}`;
...
export function createWalletCellRawTx(
  ...
  const walletOldCapacity = walletCells.capacity;
...
//   const walletNewCapacity = walletOldCapacity.add(toAmount);
  ...
  rawTx.outputs.push({
    capacity: `0x${new BN(45000000000).toString(16)}`,
    lock: dataLockScript,
  });
