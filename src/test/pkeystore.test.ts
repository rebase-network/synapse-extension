...
describe('privateKey <===> Keystore', () => {
  it('01- private encrypt keystore', () => {
    const v3 = encrypt(
      Buffer.from('cf0e22f14b26fc17cd2c001e13d3e910268483a441bd9c26ccda61330cd82c56', 'hex'),
      '123456',
    );
    console.log(v3);
    expect(v3).not.toBeNull();
  ...
  const expectMnemonic =
    'child lawsuit patch wage cook assault jelly miss repair output bring tennis';
