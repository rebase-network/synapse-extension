...
describe('wallet', () => {
  ...
  const longSeed = Buffer.from('fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542', 'hex')
...
describe('load and check password', () => {
  ...
  const keystore = Keystore.create(new ExtendedPrivateKey(fixture2.privateKey, fixture2.chainCode), password)
