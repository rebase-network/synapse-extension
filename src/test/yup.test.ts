  ...
  it("send tx validate", async () => {
    ...
    const contactSchema = Yup.object({
      address: Yup.string().trim()
        .required("address Required").length(46).matches(/^ckb|ckt/),
      amount: Yup.number()
    ...
    const err1 = await contactSchema.validate({
      address: okAddr,
      amount: 35.5,
      fee: "123",
      password: " 111 ",
    ...
    const err2 = await contactSchema.validate({
      address: okTestAddr,
      amount: 35.5,
      fee: "123",
      password: "   ",
    ...
    const err3 = await contactSchema.validate({
      address: "okAddr",
      amount: 35.5,
      fee: "123",
      password: " 111 ",
    ...
    const err4 = await contactSchema.validate({
      address: "a".repeat(46),
      amount: 35.5,
      fee: "123",
      password: " 111 ",
    ...
    const err5 = await contactSchema.validate({
      address: "a".repeat(46),
      amount: 35.5,
      fee: "-123",
      password: " 111 ",
